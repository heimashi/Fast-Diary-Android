...
public class DetailRecyclerViewAdapter extends RecyclerView.Adapter<DetailRecyclerViewAdapter.ViewHolder> {
    ...
    public DetailRecyclerViewAdapter(Context mContext, List<NoteCard> datas) {
    ...
    public DetailRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_card_select,parent, false);
    ...
    public void onBindViewHolder(final DetailRecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        if(!TextUtils.isEmpty(card.getContent())){
            ...
            holder.mRecoderTime.setText(card.getVoiceLength() + "''");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public View mRecoder;
        public TextView mRecoderTime;

        public ViewHolder(View view) {
            super(view);
            mView = view;
            mImageView= (ImageView)view.findViewById(R.id.select_note_iv);
            mTextView= (TextView)view.findViewById(R.id.select_note_tv);
            mRecoderView=(LinearLayout)view.findViewById(R.id.id_recorder_layout);
            mRecoder=view.findViewById(R.id.id_recorder_anim);
